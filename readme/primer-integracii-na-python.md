...
## Быстрая навигация
- [Создание заказа (Python)](#создание-заказа-python)
- [Сервер для обработки webhook (Python)](#сервер-для-обработки-webhook-python)
- [Создание заказа (альтернативная версия)](#создание-заказа-альтернативная-версия)

```

### Код для создания нового платежного заказа
